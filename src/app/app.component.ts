...
@Component({
  ...
  styles: [
    `
      ...
      /* --- OPTIMISATION ET FILTRES MATÉRIELS DU SCANNER --- */
      ...
      .camera-wrapper video { 
        ...
        height: 100%; 
        object-fit: cover; 
        /* Traitement d'image matériel pour faire ressortir les barres sombres */
        filter: contrast(1.5) brightness(0.85) saturate(0); 
      }
      
      /* Cadre de visée pour aider l'utilisateur à bien aligner l'EAN */
      .scanner-target-zone {
        position: absolute;
        top: 30%;
        left: 10%;
        ...
        border-radius: 6px;
        pointer-events: none;
        box-shadow: 0 0 0 9999px rgba(0, 0, 0, 0.4); /* Assombrit le contour extérieur */
      }
      ...
      .hint { font-size: 0.75rem; color: #94a3b8; margin-top: 8px; font-style: italic; }
      ...
      .invoice-tag { background: #2563eb; color: white; padding: 1px 4px; font-size: 0.7rem; font-weight: 700; border-radius: 3px; margin-right: 4px; }
      ...
      @media print {
        ...
        #receipt-zone .card-header h3::before { content: "✨ TOUBA SMART SHOP ✨\nDakar, Sénégal\n--------------------------\n"; white-space: pre; display: block; }
        ...
        .summary-row::after { content: "\n--------------------------\nMerci pour votre visite !"; white-space: pre; display: block; text-align: center; font-size: 10px; margin-top: 10px; }
      }
    `
  ]
})
